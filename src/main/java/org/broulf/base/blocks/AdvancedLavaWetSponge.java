...
public class AdvancedLavaWetSponge extends Block {

    // Super
    public AdvancedLavaWetSponge(Properties properties) {
        super(properties);
    }
    ...
    public void onPlace(BlockState blockState, Level level, BlockPos pos, BlockState stateBlock, boolean bool) {
        if (level.getBiome(pos).coldEnoughToSnow(pos)) {
            level.setBlock(pos, ModBlocks.ADVANCED_LAVA_SPONGE.get().defaultBlockState(), 2);
